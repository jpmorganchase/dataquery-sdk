...
from dataquery.exceptions import (
    ...
    RateLimitError, NotFoundError, DownloadError, AvailabilityError
)
...
class TestDataQueryClientConnections:
    ...
    async def test_connect_with_full_configuration(self):
        ...
        with patch('aiohttp.ClientSession') as mock_session_class, \
            ...
            mock_auth_class.assert_called_once_with(login="proxy_user", password="proxy_pass")
...
class TestDataQueryClientSyncWrappers:
    ...
    def test_check_availability_sync(self):
        ...
        with patch.object(client, 'check_availability_async', return_value=expected_result) as mock_async, \
