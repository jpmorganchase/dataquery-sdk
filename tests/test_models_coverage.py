...
class TestErrorModelCoverage:
    ...
    def test_information_model(self):
        ...
        info = Information(code="INFO_001", description="Information message")
        assert info.code == "INFO_001"
        assert info.description == "Information message"

    def test_available_model(self):
        """Test Available model."""
        available = Available(code="AVAILABLE", description="Services are functioning")
...
class TestModelSerialization:
    ...
    def test_error_response_serialization(self):
        ...
        error = ErrorResponse(code=500, description="Internal Server Error")
