...
from dataquery.rate_limiter import (
    QueuePriority, RateLimitConfig, RateLimitState, TokenBucketRateLimiter,
    RateLimitContext, EnhancedTokenBucketRateLimiter, QueuedRequest
)
...
class TestRateLimitConfigDetails:
    ...
    def test_config_attributes_exist(self):
        ...
        expected_attrs = [
            'requests_per_minute', 'burst_capacity', 'enable_rate_limiting',
            'window_size_seconds', 'queue_timeout', 'max_queue_size'
        ]
...
class TestRateLimitStateDetails:
    ...
    def test_state_attributes_exist(self):
        ...
        expected_attrs = [
            'tokens', 'request_count', 'consecutive_failures', 
            'last_refill', 'current_backoff'
        ]
