...
class TestNotFoundError:
    ...
    def test_not_found_error_with_custom_message(self):
        ...
        assert "Custom not found message - Details: {'resource_type': 'Resource', 'resource_id': 'test_id'}" in str(
            error
        )
...
class TestAvailabilityError:
    ...
    def test_availability_error_basic(self):
        ...
        assert "Availability check failed - Details: {'file_group_id': 'test_file', 'group_id': 'test_group'}" in str(
            error
        )
        assert error.details["file_group_id"] == "test_file"
        assert error.details["group_id"] == "test_group"
    ...
    def test_availability_error_with_custom_message(self):
        ...
        assert "Custom availability error - Details: {'file_group_id': 'test_file', 'group_id': 'test_group'}" in str(
            error
        )
