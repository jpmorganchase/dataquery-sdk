...
from dataquery.connection_pool import (
    ConnectionPoolConfig, ConnectionPoolMonitor, ConnectionPoolStats
)
...
class TestConnectionPoolStatsDetails:
    ...
    def test_stats_attributes(self):
        ...
        expected_attrs = [
            ...
            'connection_errors', 'connection_timeouts', 'last_cleanup',
            'cleanup_count', 'max_connections_reached', 'connection_wait_time', 'avg_connection_lifetime'
        ]
