...
2. Search [existing issues](https://github.com/jpmorganchase/dataquery-sdk/issues)
3. Create a [new issue](https://github.com/jpmorganchase/dataquery-sdk/issues/new) with details
