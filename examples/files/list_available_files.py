    ...
    try:
        ...
        for date_range in date_ranges:
            ...
            try:
                ...
                # Count unique dates
                unique_dates = set(f.get('file_datetime') for f in available_files 
        ...
        print(f"{'Range':<15} {'Files':<8} {'Size (MB)':<12} {'Dates':<8} {'Avg Size':<12}")
        print("-" * 60)
        ...
        for name, result in analysis_results.items():
            if "error" not in result:
                ...
                print(f"{name:<15} {result['file_count']:<8} {size_mb:<12.2f} {result['unique_dates']:<8} {avg_size:<12,.0f}")
            else:
