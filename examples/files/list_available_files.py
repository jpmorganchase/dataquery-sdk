...
def parse_args():
    ...
    parser.add_argument("--group-id", required=True, help="ID of the group to list files from")
    parser.add_argument("--file-group-id", help="Optional file group ID to filter by")
    parser.add_argument("--start-date", help="Start date (YYYYMMDD). Defaults to 7 days ago.")
