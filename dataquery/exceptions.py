...
class DownloadError(DataQueryError):
    ...
    def __init__(self, file_group_id: str, group_id: str, message: str = "Download failed", details: Optional[Dict[str, Any]] = None):
        if details is None:
            details = {}
...
class AvailabilityError(DataQueryError):
    ...
    def __init__(self, file_group_id: str, group_id: str, message: str = "Availability check failed", details: Optional[Dict[str, Any]] = None):
        if details is None:
            details = {}
        details.update({"file_group_id": file_group_id, "group_id": group_id})
        super().__init__(message, details)
...
class WorkflowError(DataQueryError):
    ...
    def __init__(self, workflow_name: str, message: str = "Workflow failed", details: Optional[Dict[str, Any]] = None):
        if details is None:
            details = {}
