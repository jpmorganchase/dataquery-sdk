...
class DownloadOptions(BaseModel):
    ...
    range_header: Optional[str] = Field(default=None, description="Custom range header (e.g., 'bytes=0-1023')")
...
class Attribute(BaseModel):
    ...
    attribute_id: str = Field(..., alias="attribute-id", description="Unique attribute measure identifier")
    attribute_name: str = Field(..., alias="attribute-name", description="Attribute short name")
    expression: str = Field(..., description="Traditional DataQuery time-series identifier")
    ...
    time_series: Optional[List[List[Union[str, float]]]] = Field(None, alias="time-series", description="Time series data")
...
class GridDataSeries(BaseModel):
    ...
    error_message: Optional[str] = Field(None, alias="errorMessage", description="Error message for this specific expression")
...
class GridDataResponse(BaseModel):
    ...
    error_message: Optional[str] = Field(None, alias="errorMessage", description="Error message for the entire API request")
...
class ErrorResponse(BaseModel):
    ...
    interaction_id: Optional[str] = Field(None, alias="x-dataquery-interaction-id", description="Interaction ID for traceability")
...
class TimeSeriesParameters(BaseModel):
    ...
    nan_treatment: NanTreatment = Field(NanTreatment.NA_NOTHING, alias="nan-treatment", description="Missing data treatment")
