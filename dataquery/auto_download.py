...
class AutoDownloadManager:
    ...
    async def start(self):
        ...
        self.logger.info(f"Starting auto-download for group '{self.group_id}' "
    ...
    async def _download_file(self, file_id: str, date_str: str, file_key: str):
        ...
        try:
            ...
            if succeeded:
                ...
                self.logger.error(f"Download failed for '{file_id}' for {date_str}: {error_msg}")
    ...
    def __repr__(self) -> str:
        ...
        return (f"AutoDownloadManager(group_id='{self.group_id}', "
